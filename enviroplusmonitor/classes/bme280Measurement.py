    ...
    class MeasurementsProperty (UserList):
        ...
        class Item(UserDict):
            ...
            class LabelProperty(object):
                ...
                def Set(self, new_value) -> Bme280Measurement.MeasurementsProperty.Item.LabelProperty:
                    if isinstance(new_value, type(self)):
                        self._value = new_value._value
                    elif isinstance(new_value, str):
                        self._Validate(new_value)
                        ...
                        raise TypeError("The provided type was not a Bme280Measurement.MeasurementsProperty.Item.LabelProperty or a str")
                    return self
            ...
            class ValueProperty(object):
                ...
                def Set(self, new_value) -> Bme280Measurement.MeasurementsProperty.Item.ValueProperty:
                    if isinstance(new_value, type(self)):
                        self._value = new_value._value
                        ...
                        raise TypeError("The provided type was not a Bme280Measurement.MeasurementsProperty.Item.ValueProperty or a float")
                    return self
            ...
            class UnitsProperty(object):
                ...
                def Set(self, new_value) -> Bme280Measurement.MeasurementsProperty.Item.UnitsProperty:
                    if isinstance(new_value, type(self)):
                        self._value = new_value._value
                    elif isinstance(new_value, str):
                        self._Validate(new_value)
                        ...
                        raise TypeError("The provided type was not a Bme280Measurement.MeasurementsProperty.Item.UnitsProperty or a str")
                    return self
            ...
            def SetLabel(self, new_value) -> Bme280Measurement.MeasurementsProperty.Item:
            ...
            def SetValue(self, new_value) -> Bme280Measurement.MeasurementsProperty.Item:
            ...
            def SetUnits(self, new_value) -> Bme280Measurement.MeasurementsProperty.Item:
